...
On the LED Preferences page, configure the Squelch for a value to reduce your background noise for effects starting with a single '*'. Typically, values between 10 and 20 should suffice. The higher the number, the greater the background noise is removed.
