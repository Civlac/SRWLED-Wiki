...
You now have SEGENV.data[SEGLEN] allocated for your use. Adding a structure for use with your segment is a whole other level of complexity and can be found by examining mod_multi_comet among others. Just search for SEGENV.allocateData in FX.cpp.
